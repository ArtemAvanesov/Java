...
9) Реализовать структуру состояющую из двух классов: People, Cat. Класс  People должен обладать атрибутами хранящими информацию о фамилии, имени, возрасте и о кошках, принадлежащих данному человеку. Класс Cat должет иметь атрибуты имени, возраста и породы.
